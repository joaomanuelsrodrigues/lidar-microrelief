...
| `max_area_km2` | 200.0 | `tiles.py`, `select_tiles()` | Provider's stated download cap for a single request | Actual download limit if provider publishes it; otherwise largest single request in production |
