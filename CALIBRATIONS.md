...
every threshold in this register — `cell`, `d_max_interp_m`, `max_window_m`,
`elevation_threshold_m`, `max_elevation_m` — is stated in metres and would be silently meaningless
under a geographic CRS. What the guard prevents is a *plausible* wrong answer, which is the one
