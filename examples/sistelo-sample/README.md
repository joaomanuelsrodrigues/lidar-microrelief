...
- `expected/` holds the record and per-band digests from the author's run, which the test suite
  reproduces on every CI run.
...
43.1 % interpolated · 0.7 % undetermined; measured density 17.3 pts/m²; record hash `9df5586d283e`.
